                    ...
                    "slidesPerView": 3
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide text-center">
                                <a class="d-inline-flex align-items-center justify-content-center bg-body-secondary rounded-circle mb-3" href="shop-catalog-grocery.html" style="width: 174px; height: 174px">
                                ...
                                <ul class="list-unstyled fs-sm m-0 mb-1">
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Tomato ketchup</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Hollandaise sauce</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Mayonnaise</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Caesar salad</a>
                                    </li>
                                </ul>
                            ...
                            <div class="swiper-slide text-center">
                                ...
                                <ul class="list-unstyled fs-sm m-0 mb-1">
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Oranges</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Apples</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Watermelons</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Exotic fruits</a>
                                    </li>
                                </ul>
                                <div class="nav justify-content-center">
                                    <a class="nav-link animate-underline px-0" href="shop-catalog-grocery.html">
                            ...
                            <div class="swiper-slide text-center">
                                ...
                                <ul class="list-unstyled fs-sm m-0 mb-1">
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Poultry</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Kosher meat</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Veal and beef</a>
                                    </li>
                                    <li>
                                        <a class="hover-effect-underline text-body text-decoration-none" href="shop-catalog-grocery.html">Turkey</a>
                                    </li>
                                </ul>
                                <div class="nav justify-content-center">
                                    <a class="nav-link animate-underline px-0" href="shop-catalog-grocery.html">
